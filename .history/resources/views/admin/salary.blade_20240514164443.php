            ...
            <div class="modal-content">
                <form method="POST" id="editEmployeeForm">
                  ...
                  <div class="modal-body">
                    ...
                    <div class="mb-3">
                      <h6>Thời gian <span id="month"></span></h6>
                    </div>
                    <div class="mb-3">
                      <h6>Tổng số giờ làm việc <span id="work_hour"></span> giờ</h6>
                    </div>
                    <div class="mb-3">
                      <h6>Lương nhận được: <span id="salary"></span> đồng</h6>
                    </div>
                    <div class="mb-3">
                      <h6>Tình trạng: <span id="salary"></span> đồng</h6>
                    </div>
                  </div>
