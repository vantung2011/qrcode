            ...
            <div class="modal-content">
                <form method="POST" id="editEmployeeForm">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                          <h6 for="editName" class="form-label"><b>Thời gian: Tháng {{ \Carbon\Carbon::parse($userScan->month)->format('m/Y') }}
                        </b></h6>
                        </div>
                        <div class="mb-3">
                          <h6 for="editName" class="form-label"><b>Số giờ đã làm việc: {{ $userScan->work_hours }}</b></h6>
                        </div>
                    </div>
