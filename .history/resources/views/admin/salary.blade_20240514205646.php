                ...
                <form method="GET" id="editEmployeeForm">
                  ...
                  <div class="modal-body">
                    ...
                    <div class="mb-3">
                      ...
                      <!-- Menu dropdown để chọn trạng thái -->
                      ...
                      <script>
                      // Hàm để cập nhật giá trị của trường input ẩn khi trạng thái thay đổi
...
<div>
  <script>
    ...
    //     // You can perform further actions here, like sending the new status to the server
    //     console.log("New status:", newStatus);
    //     // Close the modal
    //     $('#salaryPayment').modal('hide');
    // }
    </script>
@endsection