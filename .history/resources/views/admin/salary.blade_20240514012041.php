...
<div class="container">
  <div class="table-wrapper h-200 shadow-lg mt-8">
      ...
      <tr>
        ...
        <td><a href="#editEmployeeModal" class="edit" data-bs-toggle="modal" data-id="{{ $user->id }}" data-name="{{ $user->name }}" data-email="{{ $user->email }}" data-username="{{ $user->username }}" data-salary="{{$user->salary}}">
