  ...
  var html5QrcodeScanner = new Html5QrcodeScanner(
    ...
    $(document).ready(function() {
        $('#formQrCode').submit(function(event) {
            ...
            // Kiểm tra nếu trường input không có giá trị thì không thực hiện submit
            if (inputField.trim() !== '') {
            document.getElementById('myForm').submit(); // Tự động submit form nếu input không trống
        }

            var formData = {
                qrcodeData: inputData
            };
