...
<div class="body">
<div style="width: 500px" id="reader"></div></br></br></br>
<form id="formQrCode" method="post" >
  @csrf
    <input type="submit"  id="qrcode" style="opacity: 100">
    <input type="text" id="qrcodeData" name="qrcodeData"  style="opacity: 100">
