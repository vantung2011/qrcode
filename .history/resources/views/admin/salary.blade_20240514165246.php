            ...
            <div class="modal-content">
                <form method="POST" id="editEmployeeForm">
                  ...
                  <div class="modal-body">
                    <div class="mb-3">
                      <div class="mb-3">
                        <h5>Name: <b id="name"></b></h5>
                      </div>
                      <div class="mb-3">
                        <h5>Email: <b id="email"></b></h5>
                      </div>
                      <div class="mb-3">
                        <h5>Thời gian: <b id="month"></b></h5>
                      </div>
                      <div class="mb-3">
                        <h5>Tổng số giờ làm việc: <b id="work_hour"></b> giờ</h5>
                      </div>
                      <div class="mb-3">
                        <h5>Lương nhận được: <b id="salary"></b> đồng</h5>
                      </div>
                      <div class="mb-3">
                        <h5>Tình trạng: <b id="status"></b></h5>
                      </div>
