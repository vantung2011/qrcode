...
<body>
    <div id="app">
        ...
        hadow-sm p-3"
            style="background: #1c2938; margin: 8px 10px">
            <div class="container">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @else
                            @if (Auth::user()->role_id == 1)
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('users.index') }}" style="color: #fff;">Nhân viên</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('timesheet.index') }}" style="color: #fff;">Bảng chấm
                                        công</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="/salary" style="color: #fff;">Lương nhân viên</a>
                                </li>
                            @endif
                            <li class="nav-item">
                                <a class="nav-link" href="/salary/{{ Auth::user()->id }}" style="color: #fff;">Quản lý
                                    lương</a>
                            </li>
                            <li class="nav-item dropdown item-name">
                                <a id="navbarDropdown" class="nav-link dropdown-toggle" href="" role="button"
                                    data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre
                                    style="color: #fff;">Xin chào,
                                    {{ Auth::user()->name }}
                                </a>
                                <div class="dropdown-menu dropdown-menu-end p-3" aria-labelledby="navbarDropdown">
                                    <a id="profile-link" href="/profile/{{ Auth::user()->id }}" class="dropdown-item">Thông
                                        tin </a>
